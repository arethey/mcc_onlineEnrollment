...
if ($res) {
    ...
    redirect(web_root."admin/enrollees/index.php?view=newEnrollee");
                ...
                <td><label>Course/Year</label></td>
                    <td colspan="2">
                        ...
                        <select class="form-control input-sm" name="COURSE" required>
                                    ...
                                    $mydb->setQuery("SELECT * FROM `course` WHERE COURSE_LEVEL");
                    ...
                    <td colspan="2">
                        <select class="form-control input-sm" name="CIVILSTATUS" required>
                            <option value="<?php echo isset($_SESSION['CIVILSTATUS']) ? $_SESSION['CIVILSTATUS'] : ''; ?>"><?php echo isset($_SESSION['CIVILSTATUS']) ? $_SESSION['CIVILSTATUS'] : 'Select'; ?></option>

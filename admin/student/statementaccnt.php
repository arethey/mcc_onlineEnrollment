...
<div class="wrapper"> 
    <section class="invoice">
      <!-- title row -->
      <div class="row">
        <h3 align="center">Certificate of Registration</h3>
      </div>
      <div class="row">
        <div class="col-xs-12">
...
?> 
    <table class="table table-striped">
     ...
     <div
                        style='display: flex; align-items: center; justify-content: space-between; padding: 0 1rem; margin-top: 100px'>
                        <p style='border-top: 1px solid black'>Student Signature Above Printed Name</p>
                        <p style='border-top: 1px solid black; text-align: center'>College Registrar</p>
                    </div>
<?php
}
?>

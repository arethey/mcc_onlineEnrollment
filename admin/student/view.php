  ...
  <div class="col-md-8"><h2>Student Information</h2></div>
    ...
    <tr>
      ...
      <td><label>Contact No.</label></td>
        <td colspan="3"><input required="true"  class="form-control input-md" id="CONTACT" name="CONTACT" placeholder="Contact Number" type="number" value="<?php echo $res->CONTACT_NO; ?>">
              </td>

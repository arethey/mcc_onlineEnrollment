...
<title><?php echo $title; ?> | Madridejos Community College</title>
...
<div class="navbar-fixed-top navbar-TOPsm  col-md-10    col-md-offset-1"    role="navigation">
  <div class="container">
    <div class="navbar-header">
          <h5 class="navbar-menu p" >Madridejos Community College Enrollment System</h5>
        ...
        <ul class="navbar-nav p navbar-left tooltip-demo" style="margin-left:-8%;"> 
            <li class="dropdown dropdown-toggle ">
              <a  data-toggle="tooltip" data-placement="left" title="Contact Us"   href="<?php echo web_root.'index.php?q=contact';  ?>"> 
               <i class="fa fa-phone fa-fw"> </i>  Call Us:  (083) 123-123 OR Email Us: mcc@gmail.com
              </a>
            </li>
            <li><span>    ||    </span></li>
            <li>
   ...
   <div class="col-md-4">
    <div class="row "> 
     <p > 
        ...
        <h1 align="center" >Madridejos Community College Enrollment System</h1>
        </a>
    </p>
 ...
 <div class="navbar navbar-static-top navbar-magbanua col-md-10    col-md-offset-1 "    role="navigation">
      ...
      <div class="container ">
       ...
       <!--  <a class="navbar-brand"  href="<?php echo web_root; ?>index.php" title="View Sites">Madridejos Community College Enrollment System</a> -->
        </div>
<?php
...
?>
            ...
            <footer class="panel-footer" style="background-color:#098744;color:#fff;" >
              <p align="left" >&copy; Madridejos Community College Enrollment System</p>
           </footer>
      </div>
